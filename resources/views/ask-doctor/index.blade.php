                            ...
                            <form action="{{ route('ask_a_doctor.store') }}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <input type="text" class="form-control" id="mobileNo" placeholder="Mobile No." name="patMobileNo" value="{{ old('mobileNo') }}" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10">
                                    </div>
                                    <div class="form-group col-md-6">
