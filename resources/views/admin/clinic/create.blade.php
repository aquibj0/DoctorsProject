                            ...
                            <div>
                                ...
                                <form action="{{ url('/admin/clinic') }}" method="POST">
                                   ...
                                   <div class="text-center mt-3">
                                        <a href="/admin/clinic" class="btn btn-maroon btn-md text-center mt-4 mb-2"><u>Back</u></a>
                                   </div>
                                </form>
