                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register_user') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="addressLine2" type="text" class="form-control @error('addressLine2') is-invalid @enderror" name="addressLine1" value="{{ old('addressLine2') }}" required autocomplete="addressLine2" autofocus>
